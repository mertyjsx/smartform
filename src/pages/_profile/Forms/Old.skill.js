             ...
             <Grid container direction={"row"} xs={12} spacing={3} className="mt-30">
              <Grid container xs={12} md={7} className="p-12" alignItems="center" alignContent="center" >
                <form  autoComplete="off" className="fullw">
                  ...
                  <TextField disabled={!enabled}  value={data["skill"]} className="fullw" onChange={handleChange} id="outlined-basic" name="skill" label="interest name" variant="outlined" required />
                </form>
              </Grid>
              <Grid item xs={12} md={5} className="p-12">
                ...
                <MultipleSelect
isDisabled={!enabled}
defaultValue={calculate("skill")}
                  className="multiSelect"
                  isMulti={true}
                  onChange={(e) => handleCheckbox("skill", e)}
                  options={options}
                />
              </FormControl>
            </Grid>
          ...
          <Grid container direction={"row"} xs={12} spacing={3} className="mt-30">
            <Grid container xs={12} md={7} className="p-12"  alignItems="center" alignContent="center" >
              <form  autoComplete="off" className="fullw">
                ...
                <TextField disabled={!enabled}  value={data["skill_desc"]} className="fullw" onChange={handleChange} id="outlined-basic" name="skill_desc" label="ınterest description" variant="outlined" required />
              </form>
            </Grid>
            <Grid item xs={12} md={5} className="p-12">
              <FormControl variant="outlined" className="rightselect" >
                <MultipleSelect
   isDisabled={!enabled}
defaultValue={calculate("skill_desc")}
                  className="multiSelect"
                  isMulti={true}
                  onChange={(e) => handleCheckbox("skill_desc", e)}
                  options={options}
                />
                </FormControl>
              </Grid>
            ...
            <Grid container xs={12} md={7} className="p-12"  alignItems="center" alignContent="center" >
              <form  autoComplete="off" className="fullw">
                ...
                <TextField disabled={!enabled}  value={data["level"]} className="fullw" onChange={handleChange} id="outlined-basic" name="level" label="ınterest description" variant="outlined" required />
              </form>
            </Grid>
            <Grid item xs={12} md={5} className="p-12">
              <FormControl variant="outlined" className="rightselect" >
                <MultipleSelect
   isDisabled={!enabled}
defaultValue={calculate("level")}
                  className="multiSelect"
                  isMulti={true}
                  onChange={(e) => handleCheckbox("level", e)}
                  options={options}
                />
                </FormControl>
              </Grid>
            ...
            <Grid container xs={12} md={7} className="p-12"  alignItems="center" alignContent="center" >
              <form  autoComplete="off" className="fullw">
                ...
                <TextField disabled={!enabled}  value={data["experience_year"]} className="fullw" onChange={handleChange} id="outlined-basic" name="experience_year" label="ınterest description" variant="outlined" required />
              </form>
            </Grid>
            <Grid item xs={12} md={5} className="p-12">
              <FormControl variant="outlined" className="rightselect" >
                <MultipleSelect
   isDisabled={!enabled}
defaultValue={calculate("experience_year")}
                  className="multiSelect"
                  isMulti={true}
                  onChange={(e) => handleCheckbox("experience_year", e)}
                  options={options}
                />
                </FormControl>
              </Grid>
